...
class Changes():
  ...
  def __init__(self,  notifier: Optional[Callable[[models.StatusUpdate, Optional[models.Status]], None]] = None):
  ...
  def post_update(self):
    ...
    self._saved_status = None # don't hold on to old state
...
class Api:
  ...
  def __init__(self, settings: models.AppSettings = models.AppSettings(), change_notifier: Optional[Callable[[models.StatusUpdate, Optional[models.Status]], None]] = None):
    self.reinit(settings, change_notifier)
    self._initialized = True

  def reinit(self, settings: models.AppSettings = models.AppSettings(), change_notifier: Optional[Callable[[models.StatusUpdate, Optional[models.Status]], None]] = None, config: Optional[models.Status] = None):
  ...
  def _update_groups(self) -> None:
    ...
    for group in self.status.groups:
      ...
      vol_delta = utils.vol_float_to_db(group.vol_f)
  ...
  def set_group(self, gid, update: models.GroupUpdate, internal: bool = False) -> ApiResponse:
    ...
    # Handle non volume changes (volume changes are aggregated from zones)
