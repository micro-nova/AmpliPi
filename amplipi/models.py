...
class fields(SimpleNamespace):
  ...
  Volume = Field(ge=-255, le=0, description='Output volume in dB')
  GroupMute = Field(description='Set to true if output is all zones muted')
  GroupVolume = Field(ge=-255, le=0, description='Average input volume in dB')
...
class fields_w_default(SimpleNamespace):
  ...
  Volume = Field(default=-255, ge=-255, le=0, description='Output volume in dB')
  GroupMute = Field(default=True, description='Set to true if output is all zones muted')
  GroupVolume = Field(default=-255, ge=-255, le=0, description='Average utput volume in dB')
...
class Announcement(BaseModel):
  ...
  vol: int = Field(default=-40, ge=-255, le=0, description='Output volume in dB')
