...
def pause(params):
  print("org.bluez", "/org/bluez/hci0/dev_" + params[0].replace(":","_") + "/player0")
  player = btData.bus.get_object("org.bluez", "/org/bluez/hci0/dev_" + params[0].replace(":","_").upper() + "/player0")
