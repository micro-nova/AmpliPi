#!/usr/bin/python3
""" DLNA Metadata Translator
    This file reads/translates the metadata coming from gmrender and
...
# TODO: dlna generates state events to subscribers, in the future we should use this method instead
