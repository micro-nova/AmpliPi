...
There is also a downloadable app for iOS and Android devices, simply look for "AmpliPi" on your respective app distributor, or scan the proper qr code below:


![App Store / Play Store]( imgs/app-qrs.png)
