...
- Clean the exterior only with a dry cloth.
- Clean the interior with compressed/canned air, and only when the unit is unplugged.
...
- Do not modify, kink, or cut the power cord. Do not place the power cord near heat sources, and do not place heavy objects on the power cord and/or the unit itself; doing so may result in fire or electrical shock.
...
- Note that when the unit is turned off, it is not completely disconnected from the AC power outlet. Do not remove the cover.
