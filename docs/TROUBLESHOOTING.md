...
* **Mixing of the grounds**: AmpliPi has two different grounded lines, analog and digital. The most common way to mix them is by plugging in an audio device and attempting to power it by the usb on the rear of the unit, all usb-powered devices must be powered from a wall outlet
