...
void init_i2c1(uint8_t preamp_addr) {
  ...
  // I2C_InitStructure1.I2C_Timing = 0x10805E89; // TODO: Determine and document
  // why this value is needed for I2C2 but not I2C1
...
void init_i2c2() {
  ...
  // From 48-MHz PCLK with 100ns rise, 10ns fall -> 100 KHz
  I2C_InitStructure2.I2C_Timing = 0x10805E89;
