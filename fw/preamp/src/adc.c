/*
 * AmpliPi Home Audio
 * Copyright (C) 2012-2024 MicroNova LLC
 *
...
// SDNT2012X103F3950FTF - 0805 SMD, R0 = 10k @ 25 degC, B = 3950K
const uint8_t THERM_LUT_[] = {
    ,
...
uint32_t readAdcI2C2(const AdcDev* adc, AdcVals* vals) {
  ...
  I2C_TransferHandling(I2C2, adc->dev, 1, I2C_SoftEnd_Mode, I2C_Generate_Start_Write);
  ...
  I2C_TransferHandling(I2C2, adc->dev, adc->nchans, I2C_AutoEnd_Mode, I2C_Generate_Start_Read);
